...
void btn_event_cb(lv_event_t * e) {
    ...
    int ret = mariadb_create_table_and_insert_data(result_buffer, sizeof(result_buffer));
...
void btn2_event_cb(lv_event_t * e) {
    ...
    char result_buffer[256];
    int ret = mariadb_query_and_display_data(result_buffer, sizeof(result_buffer));
...
void create_db_tab(lv_obj_t * parent) {
    ...
    lv_obj_align(result_label, LV_ALIGN_CENTER, 0, 100);
