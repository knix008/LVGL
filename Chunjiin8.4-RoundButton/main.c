...
// Circular hit test event handler for circular buttons
...
void create_ui(void) {
    ...
    lv_obj_set_size(button_grid, 270, 355);
    lv_obj_set_style_pad_all(button_grid, 1, 0);
    lv_obj_set_style_pad_row(button_grid, 1, 0);
    lv_obj_set_style_pad_column(button_grid, 1, 0);
    ...
    // Grid: 3 columns, 5 rows (buttons - 60px size with minimal spacing)
    static lv_coord_t col_dsc[] = {70, 70, 70, LV_GRID_TEMPLATE_LAST};
    static lv_coord_t row_dsc[] = {67, 67, 67, 67, 67, LV_GRID_TEMPLATE_LAST};
    ...
    for (int i = 0; i < 12; i++) {
        ...
        lv_obj_set_size(app_widgets.buttons[i], 60, 60);  // Circle: square size (60x60)
        lv_obj_set_style_radius(app_widgets.buttons[i], LV_RADIUS_CIRCLE, 0);  // Perfect circle
        lv_obj_add_flag(app_widgets.buttons[i], LV_OBJ_FLAG_ADV_HITTEST);  // Enable advanced hit testing
        ...
        lv_obj_add_event_cb(app_widgets.buttons[i], circle_hit_test_event_cb, LV_EVENT_HIT_TEST, NULL);
    ...
    lv_obj_set_size(app_widgets.mode_button, 60, 60);  // Circle: square size (60x60)
    lv_obj_set_style_bg_color(app_widgets.mode_button, lv_color_hex(0xFF8C00), 0);  // Orange color
    lv_obj_set_style_radius(app_widgets.mode_button, LV_RADIUS_CIRCLE, 0);  // Perfect circle
    lv_obj_add_flag(app_widgets.mode_button, LV_OBJ_FLAG_ADV_HITTEST);  // Enable advanced hit testing
    ...
    lv_obj_add_event_cb(app_widgets.mode_button, circle_hit_test_event_cb, LV_EVENT_HIT_TEST, NULL);
    ...
    lv_obj_set_grid_cell(app_widgets.clear_button, LV_GRID_ALIGN_CENTER, 1, 1,
                        LV_GRID_ALIGN_CENTER, 4, 1);
    lv_obj_set_size(app_widgets.clear_button, 60, 60);  // Circle: square size (60x60)
    lv_obj_set_style_bg_color(app_widgets.clear_button, lv_color_hex(0xE74C3C), 0);  // Red color
    lv_obj_set_style_radius(app_widgets.clear_button, LV_RADIUS_CIRCLE, 0);  // Perfect circle
    lv_obj_add_flag(app_widgets.clear_button, LV_OBJ_FLAG_ADV_HITTEST);  // Enable advanced hit testing
    ...
    lv_obj_add_event_cb(app_widgets.clear_button, circle_hit_test_event_cb, LV_EVENT_HIT_TEST, NULL);
    ...
    lv_obj_set_grid_cell(app_widgets.enter_button, LV_GRID_ALIGN_CENTER, 2, 1,
                        LV_GRID_ALIGN_CENTER, 4, 1);
    lv_obj_set_size(app_widgets.enter_button, 60, 60);  // Circle: square size (60x60)
    lv_obj_set_style_bg_color(app_widgets.enter_button, lv_color_hex(0x28A745), 0);  // Green color
    lv_obj_set_style_radius(app_widgets.enter_button, LV_RADIUS_CIRCLE, 0);  // Perfect circle
    lv_obj_add_flag(app_widgets.enter_button, LV_OBJ_FLAG_ADV_HITTEST);  // Enable advanced hit testing
    ...
    lv_obj_add_event_cb(app_widgets.enter_button, circle_hit_test_event_cb, LV_EVENT_HIT_TEST, NULL);
    ...
    lv_obj_set_style_text_font(info_label, korean_font_14, 0);
}
