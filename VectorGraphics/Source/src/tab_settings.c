...
void create_settings_tab(lv_obj_t * parent) {
    ...
    lv_image_set_src(svg_img, "A:../assets/setting_icon.svg");
    ...
    if (svg_src) {
        printf("Settings tab: SVG loaded successfully: A:../assets/setting_icon.svg\n");
        printf("Settings tab: SVG source pointer: %p\n", svg_src);
    } else {
        printf("Settings tab: SVG failed to load: A:../assets/setting_icon.svg\n");
