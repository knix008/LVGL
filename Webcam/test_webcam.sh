...
run_webcam() {
    ...
    echo "Command: ./build/webcam_viewer $args"
    echo "Press ESC or Q to quit, R to toggle recording"
    echo ""

    ./build/webcam_viewer $args
}
...
show_webcam_info() {
    ...
    echo "======================"
    echo "Webcam Viewer Version: 1.0"
    echo "Build Date: $(date)"
    echo "Supported Formats: YUYV, MJPEG, H264"
    echo ""
    # List video devices
...
while true; do
    ...
    case $choice in
        ...
        4)
            ...
            echo "Command: ./build/webcam_viewer -c 0 -r webcam_recording.mp4"
            echo "Press ESC or Q to quit, R to toggle recording"
            echo ""
