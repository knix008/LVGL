...
echo "-------------------"
./build/yolov8n_video_detection --help
echo
...
echo "  ./build/yolov8n_video_detection -v ./data/traffic.mp4 -o output.mp4"
echo
echo "  # Use webcam (if available)"
echo "  ./build/yolov8n_video_detection -w 0"
echo
echo "  # Process with CUDA acceleration"
echo "  ./build/yolov8n_video_detection -v ./data/traffic.mp4 -c"
echo
echo "  # Show FPS counter"
echo "  ./build/yolov8n_video_detection -v ./data/traffic.mp4 -f"
