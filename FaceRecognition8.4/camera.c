...
void camera_cleanup(void)
{
    ...
    if (fmt_ctx) {
        ...
        // Increased delay to ensure V4L2 device is fully released
        printf("Waiting 1.5 seconds for V4L2 device to be released...\n");
        usleep(1500000);  // 1.5 seconds delay for proper device reset
