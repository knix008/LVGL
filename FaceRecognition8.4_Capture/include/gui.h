...
public:
    ...
    void set_camera_toggle_callback(std::function<void(bool)> callback);
    ...
    void show_flash(uint32_t duration_ms);
...
private:
    ...
    lv_obj_t* flash_overlay;    // White flash overlay for photo capture effect
    ...
    // SDL_mixer for shutter sound
    void* shutter_sound;        // Mix_Chunk* for shutter sound (void* to avoid SDL header dependency)
    ...
    std::function<void(bool)> on_camera_toggle;
    ...
    static void camera_toggle_btn_event_cb(lv_event_t* e);
    static void capture_frame_btn_event_cb(lv_event_t* e);
    static void live_stream_start_btn_event_cb(lv_event_t* e);
    static void live_stream_stop_btn_event_cb(lv_event_t* e);
