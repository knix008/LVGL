...
// SQLite test function for creating table and inserting data
int sqlite_create_table_and_insert_data(char *result_buffer, size_t buffer_size) {
    ...
    snprintf(result_buffer, buffer_size, "Table created & data inserted!");
    sqlite3_close(db);
    return 0;
}

// SQLite test function for querying and displaying data
