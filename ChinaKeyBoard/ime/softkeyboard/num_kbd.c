...
static md_key_t num_key_pads[] = {
    /***** 1, 2, 3, 4, 5, 6, 7, 8, 9 ,0 *****/
    { {0,KEY_ROW1_TY-KEY_MOVE_Y,73+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y	}	, '1', SCANCODE_1,         KEY_PAD_CHAR, NULL, share_key_update},
    { {86-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,153+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y}	, '2', SCANCODE_2,         KEY_PAD_CHAR, NULL, share_key_update},
    { {166-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,233+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y}	, '3', SCANCODE_3,         KEY_PAD_CHAR, NULL, share_key_update},
    { {246-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,313+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y}	, '4', SCANCODE_4,         KEY_PAD_CHAR, NULL, share_key_update},
    { {326-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,393+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y}	, '5', SCANCODE_5,         KEY_PAD_CHAR, NULL, share_key_update},
    { {406-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,473+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y}	, '6', SCANCODE_6,         KEY_PAD_CHAR, NULL, share_key_update},
    { {486-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,553+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y}	, '7', SCANCODE_7,         KEY_PAD_CHAR, NULL, share_key_update},
    { {566-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,633+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y}	, '8', SCANCODE_8,         KEY_PAD_CHAR, NULL, share_key_update},
    { {646-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,713+KEY_MOVE_X,KEY_ROW1_BY+KEY_MOVE_Y}	, '9', SCANCODE_9,         KEY_PAD_CHAR, NULL, share_key_update},
    { {726-KEY_MOVE_X,KEY_ROW1_TY-KEY_MOVE_Y,800,KEY_ROW1_BY+KEY_MOVE_Y}	, '0', SCANCODE_0,         KEY_PAD_CHAR, NULL, share_key_update},
    { {0,KEY_ROW2_TY-KEY_MOVE_Y,73+KEY_MOVE_X,KEY_ROW2_BY+KEY_MOVE_Y	}	, '-', SCANCODE_MINUS,     KEY_PAD_CHAR, NULL, share_key_update},
    { {86-KEY_MOVE_X,KEY_ROW2_TY-KEY_MOVE_Y,153+KEY_MOVE_X,KEY_ROW2_BY+KEY_MOVE_Y}	, '/', SCANCODE_SLASH,     KEY_PAD_CHAR, NULL, share_key_update},
    ...
    { {326-KEY_MOVE_X,KEY_ROW2_TY-KEY_MOVE_Y,393+KEY_MOVE_X,KEY_ROW2_BY+KEY_MOVE_Y}	, '(', SCANCODE_9,         KEY_PAD_CHAR, NULL, share_key_update},
    ...
    { {726-KEY_MOVE_X,KEY_ROW2_TY-KEY_MOVE_Y,800,KEY_ROW2_BY+KEY_MOVE_Y}	, '"', SCANCODE_APOSTROPHE,KEY_PAD_CHAR, NULL, share_key_update},
    { {0,KEY_ROW3_TY-KEY_MOVE_Y,106+KEY_MOVE_X,KEY_ROW3_BY+KEY_MOVE_Y}	, ' ', SCANCODE_TOOP,      KEY_PAD_FUNC, NULL, share_key_update},
    ...
    { {692-KEY_MOVE_X,KEY_ROW3_TY-KEY_MOVE_X,792+KEY_MOVE_X,KEY_ROW3_BY+KEY_MOVE_Y}	, ' ', SCANCODE_BACKSPACE, KEY_PAD_FUNC, NULL, share_key_update},
...
static md_key_t num_key_pads[] = {
    /***** 1, 2, 3, 4, 5, 6, 7, 8, 9 ,0 *****/ 
    { {2,63,46,96	}	, '1', SCANCODE_1,         KEY_PAD_CHAR, NULL, share_key_update},
    { {50,63,94,96	}	, '2', SCANCODE_2,         KEY_PAD_CHAR, NULL, share_key_update},
    { {97,63,142,96	}	, '3', SCANCODE_3,         KEY_PAD_CHAR, NULL, share_key_update},
    { {146,63,190,96}	, '4', SCANCODE_4,         KEY_PAD_CHAR, NULL, share_key_update},
    { {194,63,238,96}	, '5', SCANCODE_5,         KEY_PAD_CHAR, NULL, share_key_update},
    { {242,63,286,96}	, '6', SCANCODE_6,         KEY_PAD_CHAR, NULL, share_key_update},
    { {289,63,334,96}	, '7', SCANCODE_7,         KEY_PAD_CHAR, NULL, share_key_update},
    { {338,63,382,96}	, '8', SCANCODE_8,         KEY_PAD_CHAR, NULL, share_key_update},
    { {386,63,430,96}	, '9', SCANCODE_9,         KEY_PAD_CHAR, NULL, share_key_update},
    { {434,63,478,96}	, '0', SCANCODE_0,         KEY_PAD_CHAR, NULL, share_key_update},
    { {2,100,46,133	}	, '-', SCANCODE_MINUS,     KEY_PAD_CHAR, NULL, share_key_update},
    { {50,100,94,133}	, '/', SCANCODE_SLASH,     KEY_PAD_CHAR, NULL, share_key_update},
    ...
    { {194,100,238,133}	, '(', SCANCODE_9,         KEY_PAD_CHAR, NULL, share_key_update},
    ...
    { {2,137,70,170	}	, ' ', SCANCODE_TOOP,      KEY_PAD_FUNC, NULL, share_key_update},
...
int init_num_keyboard (const void* handle,HWND hWnd, key_board_t *kb)
{
	...
	if (get_keyboard_bitmap(HDC_SCREEN, (PBITMAP) (&kb->data), NUM26_KBD_BKG))
	{
		_MY_PRINTF("Fail to get key mask bitmap.\n");
		return -1;
	}
