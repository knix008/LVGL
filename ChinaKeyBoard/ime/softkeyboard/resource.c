...
#elif defined (SOFTKBD_800_1280)
#include "800-1280/en_kbd_bkg.c"
#include "800-1280/num_kbd_bkg.c"
#include "800-1280/punct_kbd_bkg.c"
#include "800-1280/pinyin_kbd_bkg.c"
#include "800-1280/char_key_mask.c"
#include "800-1280/func_key_mask.c"
#include "800-1280/left_arrow_enable.c"
#include "800-1280/left_arrow_disable.c"
#include "800-1280/right_arrow_enable.c"
#include "800-1280/right_arrow_disable.c"
#ifdef KBD_TOOLTIP
#include "800-1280/tooltip_bk.c"
#include "800-1280/tooltip_mask.c"
#include "800-1280/bitmapfont.c"
#endif

#elif defined (SOFTKBD_720_1280)
#include "720-1280/en_kbd_bkg.c"
#include "720-1280/num_kbd_bkg.c"
#include "720-1280/punct_kbd_bkg.c"
#include "720-1280/pinyin_kbd_bkg.c"
#include "720-1280/char_key_mask.c"
#include "720-1280/func_key_mask.c"
#include "720-1280/left_arrow_enable.c"
#include "720-1280/left_arrow_disable.c"
#include "720-1280/right_arrow_enable.c"
#include "720-1280/right_arrow_disable.c"
#ifdef KBD_TOOLTIP
#include "720-1280/tooltip_bk.c"
#include "720-1280/tooltip_mask.c"
#include "720-1280/bitmapfont.c"
#endif
#endif 
...
static RESDATA res [] = {
    ...
    /* func key mask data */
    { "func_key_mask.png", (unsigned char*) char_key_mask_data, sizeof(func_key_mask_data)},
    /* left arrow enable */
...
//save image 
	...
	sprintf(buf, "/mnt/mtdblock/softboardimg/%s", p->file);
	printf("path: %s \n", buf);
	fj=fopen(buf, "wb");
	if(fj)
	{
		if(p->data_size == fwrite(p->data,1, p->data_size,fj))
			printf("get softboard image ok \n");
		fclose(fj);
		sync();
	}
#endif

    if(!p || LoadBitmapFromMem (hdc, pbmp, p->data, p->data_size, 
