...
echo "Fixed Korean Keypad (Clickable)"
echo "================================"

ROOT_DIR=$(cd "$(dirname "$0")" && pwd)
cd "$ROOT_DIR"

if [ ! -x ./simple_korean_keypad_fixed ]; then
    echo "Building simple_korean_keypad_fixed..."
    make simple_korean_keypad_fixed
fi
...
echo "Starting simple_korean_keypad_fixed..."
./simple_korean_keypad_fixed
