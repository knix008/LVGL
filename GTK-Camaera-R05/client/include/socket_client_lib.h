 ...
 *
 * Provides a C++ interface to send binary protocol messages to the Unix domain
 * socket server and receive responses.
 */
...
private:
    ...
    /**
     * @brief Execute binary protocol message
     */
    Response execute_binary(const Protocol::Message& request);
};
